...
@section('content')
            ...
            <div class="bigPanel">
                ...
                <div class="bigPanelHeightCopy">
                    ...
                    <div class="sendMessageLayout">
                        <input id="message" class="form-control" style="width:100% !important;"
                            placeholder="Tapez votre message ici ..." title="Tapez">
    ...
    <style>
        ...
        .sendMessageLayout {
            ...
            padding: 0 0px;
            /* Add padding for spacing around the input and button */
        }

        #message {
            flex: 1;
            /* Let the input take up remaining space */
            max-width: calc(100% - 36px);
            /* Set maximum width for the input */
            margin-right: 10px;
        ...
        #send {
            ...
            height: auto;
            /* Set a fixed height for the send button */
            cursor: pointer;
    ...
    <script defer="">
        ...
        let friendsPanelUpdater = new PartialRefresh("/Chat/GetFriendsList", "friendsListContainer", 5,
            UpdateFriendsCallback, {
                "lastContent": true
            });
        let messagesPanelUpdater = new PartialRefresh("/Chat/GetMessages", "messagesPanel", 2, UpdateMessagesCallback, {
            "lastContent": true
        });
        ...
        function UpdateFriendsCallback() {
            ...
            $(".unselectedTarget").click(function() {
                ...
                ajaxActionCall("/Chat/SetCurrentTarget?userid=" + userId, () => {
                    friendsPanelUpdater.refresh(true);
                    messagesPanelUpdater.refresh(true);
                });
            })
        }
            ...
            $(".sent").click(function() {
                if (!editing) {
                    ...
                    $("#delete_" + message_id).click(function() {
                        setEditing(false);
                        messagesPanelUpdater.confirmedCommand("Effacer ce message",
                            "/Chat/Delete?messageid=" + message_id);
                    })
                    $("#update_" + message_id).click(function() {
                        setEditing(false);
                        var message = $("#" + message_id).val();
                        messagesPanelUpdater.command("/Chat/Update?id=" + message_id + "&message=" +
                            message);
                    })
