<div class="row align-items-center"
    ...
    <div 
    class="col-2 username" 
    style="word-wrap:break-word;" >
    <a href="/users/{{$user->id}}" title="voir profil">{{ $user->username }}</a>
    </div>
    <div 
    class="col-1 p-0" 
    style="border-left: 1px solid; width:10px;">&nbsp;
    </div>
    ...
    @if ($user->is_blocked == 0)
        <div class="col-3 d-flex align-items-center justify-content-center" style="word-wrap:break-word;">
            ...
            style="width:96px;">Bloquer</button>
    ...
    @elseif($user->is_blocked == 1)
        <div class="col-3 d-flex align-items-center justify-content-center" style="word-wrap:break-word;">
            <button type="button" class="btn btn-primary inactive" id="{{$user->id}}" data-bs-toggle="modal" data-bs-target="#unBlockUserModal" style="width:96px;">Débloquer</button>
