<div class="row align-items-center"
    ...
    @if ($signalement->status == 0)
        <div class="col-3 d-flex align-items-center justify-content-center" style="word-wrap:break-word;">
            <button id="{{$signalement->id}}" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#signalerModal">Traiter</button>
    ...
    @elseif($signalement->status == 1)
        <div class="col-3 d-flex align-items-center justify-content-center" style="word-wrap:break-word;">
            <button type="button" class="btn btn-primary inactive" disabled id="{{$signalement->id}}">Traiter</button>
